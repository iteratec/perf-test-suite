...
<head>
    ...
    <!-- Bootstrap Core CSS -->
	<link href="assets-cache-disabled/cssMinified/bootstrap.css" rel="stylesheet">
	<!-- Jquery Magnific popup css -->
	<link rel="stylesheet" type="text/css" href="assets-cache-disabled/cssMinified/magnific-popup.css">
	<!-- icons -->
	<link rel="stylesheet" type="text/css" href="assets-cache-disabled/cssMinified/font-awesome.css">
	<!-- Custom CSS -->
	<link href="assets-cache-disabled/cssMinified/header.css" rel="stylesheet">
	<link href="assets-cache-disabled/cssMinified/main.css" rel="stylesheet">
	...
	<script src="jsMinified-cache-disabled/jquery-1.11.0.js"></script>
	<script src="jsMinified-cache-disabled/jquery-ui.min.js"></script>
	<!-- Bootstrap Core JavaScript -->
	<script src="jsMinified-cache-disabled/bootstrap.min.js"></script>
	<script src="jsMinified-cache-disabled/jquery.magnific-popup.js"></script>
	<script src="jsMinified-cache-disabled/shuffle.js"></script>
	<script src="jsMinified-cache-disabled/jquery.shapeshift.js"></script>
	<script src="jsMinified-cache-disabled/homepage.js"></script>
...
<body>
    ...
    <script src="jsMinified-cache-disabled/profiler.js"></script>
    <script>
