...
<head>
    ...
    <!--[if lt IE 9]>
        ...
        <script src="https://oss.maxcdn.com/libs/respond.jsMinified/1.4.2/respond.min.js"></script>
    <![endif]-->
                ...
                <ul class="thumbnails">
                    ...
                    <li class="col-md-4">
                        <div class="thumbnail" href="assets/images/recife.jpg">
                            <a href="javascript:;">
                                <img class="attachment-portfolio-full wp-post-image" width="600" height="400" alt="Recife, Brasil" src="assets/images/recife_small.jpg">
                            </a>
                            <div class="caption">
